...
export default class Venda {
    ...
    constructor(protocolo: number, dataHora: Date, valor:number,
                duracao:number, atrasado: boolean, status: Status,
                produto: Produto, veiculo: Veiculo, origem:Aeroporto,
                destino: Aeroporto, piloto: Piloto) {
